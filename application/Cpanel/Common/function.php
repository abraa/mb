 ...
 * @return array
 */
function getDataPower($user_id = 0, $key = '') {
    return D('Cpanel/DataPower')->getPower($user_id, $key);
}
 ...
 * @return bool
 */
function checkDataPower($key = '', $value = '', $user_id = 0){
    return D('Cpanel/DataPower')->checkPower($key, $value, $user_id);
}
